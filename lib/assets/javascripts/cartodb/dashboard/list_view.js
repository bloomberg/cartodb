...
module.exports = cdb.core.View.extend({
  ...
  render: function($parent) {
    ...
    if (this.routerModel.isDatasets()) {
      ...
      this.$el.find('.DatasetsTableHeader').off('click', self._onTableHeaderClicked);
          ...
          <div class="DatasetsTable">\
            <div class="DatasetsTableHeader">\
              <div class="DatasetsTableRow">\
                ...
                <div class="DatasetsTableCell"></div>\
                <div class="DatasetsTableCell" id="name">Name' + (prevOrderBy == 'name' ? orderIcon : '') + '</div>\
                <div class="DatasetsTableCell">Description</div>\
                <div class="DatasetsTableCell" id="updated_at">Last Updated' + (prevOrderBy == 'updated_at' ? orderIcon : '') + '</div>\
                <div class="DatasetsTableCell"></div>\
              </div>\
            </div>\
          </div>\
      ...
      this.$el.find('.DatasetsTableHeader').on('click', self, self._onTableHeaderClicked);
