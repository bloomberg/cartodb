...
module.exports = cdb.core.View.extend({
  ...
  render: function($parent) {
    ...
    if (this.routerModel.isDatasets()) {
      ...
      this.$el.html('<div class="DatasetsTableHeaderContainer padded"><table class="DatasetsTable"><thead><tr><th></th><th></th><th id="name">Name' + (prevOrderBy == 'name' ? orderIcon : '') + '</th><th>Description</th><th id="updated_at">Last Updated' + (prevOrderBy == 'updated_at' ? orderIcon : '') + '</th><th></th></tr></thead></thead></table></div>\
